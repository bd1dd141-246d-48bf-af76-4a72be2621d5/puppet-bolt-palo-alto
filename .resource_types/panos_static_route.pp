...
Puppet::Resource::ResourceType3.new(
  ...
  [
    ...
    # (a Optional[Enum["ip-address", "next-vr", "discard", "none"]])
    ...
    # Specify a valid metric for the static route (1 - 65535; default is 10). (a Variant[String, Integer[1, 65535]])
    Puppet::Resource::Param(Any, 'metric'),

    # Specify the administrative distance for the static route (10-240). (a Optional[Variant[String,Integer[10, 240]]])
